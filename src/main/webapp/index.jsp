...
<%
    ...
    if (mode !=null && mode.equals("1")){
        ...
        msg = "아이디나 비밀번호를 확인 하세요";
    }
    //httpSession객체가 session이라는 이름으로 이미 생성되어 제공되고 있다.
    //이런 HttpSession은 브라우저를 닫을 때까지 사용가능함!
    //그리고 Session에 "mvo"라는 이름으로 저장되는 것이 있다면, 로그인을 한 상태로 인지하자
    //먼저 Session으로 부터 "mvo"라는 이름으로 저장된 객체를 얻어내어 object형 변수 obj에 저장하자!
...
<%
    ...
    //obj가 null 아닐 경우다. 로그인한 사람의 이름을 얻기위해 Object형으로 두면 안되고, MemVO로 형변환을 해야 이름을 얻을수 있다.
    MemVO mvo = (MemVO) obj;
%>
